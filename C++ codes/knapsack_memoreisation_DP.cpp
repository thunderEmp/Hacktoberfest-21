/*
Question: Given two arrays of items in a sack, one is the weight array and the other is a price array, and one fixed value of weight(capacity of the sack) is given. Find the maximum profit that can be carried in the sack.
*/
#include<bits/stdc++.h>
using namespace std;
